...
Your scripts expect specific folders (data/ and models/) to exist.
...
Goal: Verify data is downloaded and saved correctly.
	1. Run the loader:
Bash
...
Step 3: Training & Experiment Tracking
Goal: Train the model, log to MLflow, and save the artifact.
